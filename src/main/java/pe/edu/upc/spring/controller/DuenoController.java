...
public class DuenoController {
	...
	public String irPaginaListadoRazas(Map<String, Object> model) {
		...
		return "listDueno"; // "listRace" es una pagina del frontEnd para listar
	}

	@RequestMapping("/irRegistrar")
	public String irPaginaRegistrar(Model model) {
		model.addAttribute("dueno", new Dueno());
		return "dueno"; // "race" es una pagina del frontEnd para insertar y/o modificar
	}
		...
		throws ParseException
	{
		if (binRes.hasErrors())
			...
			boolean flag = rService.grabar(objDueno);
			if (flag)
