...
public class PetController {
	...
	public String irPaginaListadoMascotas(Map<String, Object> model) {
		...
		return "listPet"; // "listRace" es una pagina del frontEnd para listar
	}
	...
	public String irPaginaRegistrar(Model model) {
		...
		return "pet"; // "race" es una pagina del frontEnd para insertar y/o modificar
	}
		...
		throws ParseException
	{
		if (binRes.hasErrors())
			...
			boolean flag = pService.grabar(objPet);
			if (flag)
	...
	public String listar(Map<String, Object> model, @ModelAttribute Pet pet ) 
		throws ParseException{
	...
	throws ParseException
	{
		...
		pet.setNamePet(pet.getNamePet()); //capturo lo de la cajita de lista
		listaMascotas = pService.buscarNombre(pet.getNamePet()); //hago mi busqueda
